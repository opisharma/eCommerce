										...
										<div class="testimonial-one owl-carousel">
											<div class="items">
												<div class="card text-center">
													<div class="card-body">
														<img src="{{ asset('dashboard_asset') }}/images/testimonial/1.jpg" alt="">
											...
											<div class="items">
												<div class="card text-center">
													<div class="card-body">
														<img src="{{ asset('dashboard_asset') }}/images/testimonial/2.jpg" alt="">
											...
											<div class="items">
												<div class="card text-center">
													<div class="card-body">
														<img src="{{ asset('dashboard_asset') }}/images/testimonial/3.jpg" alt="">
											...
											<div class="items">
												<div class="card text-center">
													<div class="card-body">
														<img src="{{ asset('dashboard_asset') }}/images/testimonial/4.jpg" alt="">
								...
								<div class="card featuredMenu">
									...
									<div class="card-body loadmore-content height750 dz-scroll pt-0" id="FeaturedMenusContent">
										<div class="media mb-4">
											<img src="{{ asset('dashboard_asset') }}/images/menus/1.png" width="85" alt="" class="rounded mr-3">
											<div class="media-body">
										...
										<div class="media mb-4">
											<img src="{{ asset('dashboard_asset') }}/images/menus/2.png" width="85" alt="" class="rounded mr-3">
											<div class="media-body">
										...
										<div class="media mb-4">
											<img src="{{ asset('dashboard_asset') }}/images/menus/3.png" width="85" alt="" class="rounded mr-3">
											<div class="media-body">
												<h5><a href="food-menu.html" class="text-black fs-16">Fresh or Frozen (No Sugar Added) Fruits</a></h5>
										...
										<div class="media mb-4">
											<img src="{{ asset('dashboard_asset') }}/images/menus/4.png" width="85" alt="" class="rounded mr-3">
											<div class="media-body">
