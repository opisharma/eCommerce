    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <li><a href="{{ url('category') }}" class="ai-icon" aria-expanded="false">
							<i class="fa fa-th"></i>
							<span class="nav-text">Category</span>
						</a>
					</li>
                    <li><a href="{{ url('product') }}" class="ai-icon" aria-expanded="false">
				...
				<div class="copyright">
					...
					<p>Made with <span class="heart"></span> by BlackWhie Coders</p>
				</div>
			</div>
        </div>
        <!--**********************************
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="http://dexignzone.com/" target="_blank">BlackWhie Coders</a> {{ date('Y') }}</p>
            </div>
        </div>
        <!--**********************************
            Footer end
