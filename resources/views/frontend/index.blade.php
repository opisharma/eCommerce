                        ...
                        <div class="product-area clearfix">
                            ...
                            <div class="grid">
                                <div class="product-pic">
                                    <img src="{{ asset('uploads/product_photos/product_thumbnail_photos')}}/{{ $product->product_thumbnail_photo }}" alt="not found">
                                    @if ($product ->product_regular_price > $product ->product_discounted_price)
                                         <span class="theme-badge-2">{{ round(100-($product ->product_discounted_price*100)/$product ->product_regular_price) }}% off</span>
                                    @endif
                                    <div class="actions">
                                        <ul>
                                            <li>
